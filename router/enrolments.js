...
const enrolmentRequestcontroler = require("../controlers/enrollRequest");
const enrolmentcontroler = require("../controlers/enrolment");
...
router.delete("/delete/:id",permissions("student"),enrolmentRequestcontroler.delete);
//the below router take request _id as params
...
router.patch("/enable/:id",permissions("teacher","principal"),enrolmentcontroler.enableanddisable);
